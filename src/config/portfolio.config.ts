export const portfolioConfig = {
  ...
  // About Information
  about: {
    bio: "My name is Koushik S, and I am a Full-Stack Web Developer from Karur, Tamil Nadu, India. I am passionate about building modern and responsive web applications and continuously improving my development skills. I like solving problems and turning ideas into simple and effective web solutions.I focus on writing efficient code and building reliable web solutions that offer a smooth and easy user experience",
    hobbies: [
      "Coding",
      "Listening to Music",
  ...
  projects: [
    {
      title: "EXPENZO – Expense Tracker App ",
      description:
        "Expenzo is a simple and user-friendly expense tracking application that helps users manage daily spending with ease. It focuses on clean design, smooth interaction, and practical features for everyday use.",
